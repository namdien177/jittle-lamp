  ...
  return (
    <DropdownMenu
      ...
      trigger={
        <button
          type="button"
          className="inline-flex h-9 max-w-[15rem] items-center gap-2 rounded-md border border-border-strong bg-secondary px-2.5 text-sm font-medium text-foreground outline-none transition-colors hover:border-white/20 focus-visible:ring-2 focus-visible:ring-ring/40"
        >
